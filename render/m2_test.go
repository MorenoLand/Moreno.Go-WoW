...
func TestPoseM2VertexUsesBoneLookupTable(t *testing.T) {
	model := parsedM2{bones: []m2Bone{{scale: [3]float32{1, 1, 1}}, {translation: [3]float32{3, 0, 0}, scale: [3]float32{1, 1, 1}}}, boneLookup: []uint16{1}}
	skin := parsedSkin{bones: [][4]uint8{{0, 0, 0, 0}}, boneCombos: []uint16{0}}
