...
func registerGlueAPI(rt *Runtime) {
	...
	reg("GetPartyMember", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("GetPartyLeaderIndex", func(L *lua.LState) int { L.Push(lua.LNumber(0)); return 1 })
	...
	reg("GetDungeonDifficulty", func(L *lua.LState) int { L.Push(lua.LNumber(1)); return 1 })
	reg("GetRaidDifficulty", func(L *lua.LState) int { L.Push(lua.LNumber(1)); return 1 })
	reg("GetLootThreshold", func(L *lua.LState) int { L.Push(lua.LNumber(2)); return 1 })
	reg("GetOptOutOfLoot", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("IsReferAFriendLinked", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("PartialPlayTime", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("NoPlayTime", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("GetBillingTimeRested", func(L *lua.LState) int { L.Push(lua.LNumber(0)); return 1 })
	reg("GetInstanceInfo", func(L *lua.LState) int { return 7 })
	reg("CanChangePlayerDifficulty", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	...
	reg("IsMuted", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
	reg("IsThreatWarningEnabled", func(L *lua.LState) int { L.Push(lua.LFalse); return 1 })
