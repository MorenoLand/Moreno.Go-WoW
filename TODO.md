...
- [x] Make realm rows, Okay, Cancel, and Change Realm fully clickable without returning through Escape.
- [x] Remove duplicate addon rows/lines and wire addon selection plus all dialog buttons.
...
- [x] Verify visual changes from the actual `go run .` window with OS-level captures; do not treat framebuffer color artifacts as client behavior.
